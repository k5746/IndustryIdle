export const ZH_CN = {
    ...
    PrestigeAlertContent:
        "您的公司将被清算。您将以 %{amount} 瑞士货币兑现并在 %{city} 成立新公司",
